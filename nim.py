...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        ...
        # update self.q
        self.q[convState, action] = old_q + (self.alpha * ((reward + future_rewards) - old_q))
        return 0
    ...
    def best_future_reward(self, state):
        ...
        pileTracker = -1
        # for every amount of numbersLeft in state array
        for pile in state:
            pileTracker += 1
            ...
            for num in range(1,pile + 1):
                ...
                # define actionVal under KeyError friendly terms
                try:
                    actionVal = self.q[tupeState, (pileTracker, num)]
                except:
                    actionVal = 0

                # if new val is greater than recorded, overwrite recorded
